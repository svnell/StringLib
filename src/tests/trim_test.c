...
// trim_2:0: Assertion 'psrc == "Hello, World! *&#@"' failed: psrc == "",
// "Hello, World! *&#@" == "Hello, World! *&#@" trim_all_empty:0: Passed
// trim_str_empty:0: Passed
// trim_empty:0: Assertion 'got == expected' failed: got == "", expected ==
// "+!0-aeoi2o3i23iuhuhh3O*YADyagsduyoaweq213" trim_and_str_eq:0: Assertion 'got
// == expected' failed: got == (null), expected == "" trim_test1:0: Assertion
// 'got == expected' failed: got == "Abo+ba++", expected == "Abo+ba"
// trim_test2:0: Assertion 'got == expected' failed: got == "", expected ==
// "Ab000cd" trim_test3:0: Assertion 'got == expected' failed: got == "",
// expected == "DoNotTouch" :trim_test4:0: Assertion 'got == expected' failed:
// got == "sc21 *", expected == "sc21" :trim_test5:0: Assertion 'got ==
// expected' failed: got == "Good mornin", expected == "Good morning!"
// :trim_empty_spaces:0: Assertion 'got == expected' failed: got == "", expected
// == "abc" :trim_null_ptr_trim_chars:0: Assertion 'got == expected' failed: got
// == (null), expected == "abc"
